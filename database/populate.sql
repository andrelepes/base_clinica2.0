...
INSERT INTO public.attended_options (id, title) VALUES 
(1, 'Sim'),
(2, 'Não, reagendado'),
...
INSERT INTO public.punctuality_options (id, title) VALUES 
(1, 'No horário'),
(2, 'Antecipado'),
(3, 'Atrasado');
...
INSERT INTO public.mood_states (id, value, title) VALUES 
(1, 0.5, 'Muito Ruim'),
(2, 1.0, 'Ruim'),
...
CREATE TABLE public.evolutions (
    ...
    punctuality_status INT,
    arrival_mood_state INT,
    discussion_topic TEXT,
    analysis_intervention TEXT,
    next_session_plan TEXT,
    departure_mood_state INT,
...
-- Added on 21/02/2025 by gabrielpaiv
